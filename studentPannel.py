...
def students_panel(account_type,student,imagename,un,pw,butlist):
    ...
    if account_type=='student':
        ...
        name,  surname, rollno, course, branch, year, sem, father, mother, pcontact, dob, phone, email, country, city, pincode, adharno, dor,batch, gender,  fee, trans, address=student[:23]
            

       
    else:
        nameoffac, surnameoffac, empid, factitle, facdepart,  facph1, facph2, facdob, facgender,   facemail, facsal, faccountry, faccity,facpincode, facadhaar,facaddress=student[:16]
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    introlabel = Label(stu, text='S N M I M T', fg='white', font='none 15', bg='black')
    introlabel.place(x=70, y=9)
    intropart2 = Label(stu, text='Maliankara', fg='white', font='none 20 bold', bg='black')
