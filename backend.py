...
def newstudent():
    ...
    wobj1, wobj2, wobj3, wobj4, wobj5, wobj6, wobj7, wobj8, wobj9, wobj10, wobj13, wobj14, wobj15, wobj16, wobj17, wobj18, wobj19, wobj20, wobj23, wobj24, wobj25, wobj26, wobj27, wobj28, wobj29, wobj30 = [Mainframe2() for _ in range(26)]  #---------------------------------DIVIDERS----------------------
    ...
    wobj3.userEntry(scrollablecan,340,85,25)

    stumothername=wobjGlobal.customlabels(scrollablecan,"Mother's Name:",'none',None,510,80)
    wobj5.userEntry(scrollablecan,660,85,25)

    stuparentcontact=wobjGlobal.customlabels(scrollablecan,'Parents no: ','none',None,200,130)
    wobj4.userintentry(scrollablecan,340,135,25)
    ...
    sturollno=wobjGlobal.customlabels(scrollablecan,'Roll No:','none',None,530,240)
    ...
    stureg=wobjGlobal.customlabels(scrollablecan,'DOR:','none',None,320,340)
    ...
    wobjGlobal.customlabels(scrollablecan,'Transport Service:','none',None,280,530)
...
def newemployee():
    ...
    # Objects of Mainframe
    wobjGlobal = Mainframe2()
    wfobj1, wfobj2, wfobj3, wfobj4, wfobj5, wfobj6, wfobj7, wfobj10, wfobj11, wfobj12, wfobj13, wfobj14, wfobj15, wfobj16, wfobj17, wfobj18, wfobj19 = [Mainframe2() for _ in range(17)]
...
def showdataoffaculty(table):
    ...
    if metafacdata =='':
        ...
        # Objects of Mainframe
        wobjGlobal = Mainframe2()
        wfobju1, wfobju2, wfobju3, wfobju4, wfobju5, wfobju6, wfobju7, wfobju10, wfobju11, wfobju12, wfobju13, wfobju14, wfobju15, wfobju16, wfobju17, wfobju18, wfobju19 = [Mainframe2() for _ in range(17)]
...
def showdat(table):
        ...
        if metadata=='':
            ...
            wobj1, wobj2, wobj3, wobj4, wobj5, wobj6, wobj7, wobj8, wobj9, wobj10, wobj13,  wobj14,  wobj15,  wobj16,  wobj17,  wobj18,  wobj19,  wobj20,  wobj23,  wobj24,  wobj25,  wobj26,  wobj27,  wobj28,  wobj30,  wobj31,  wobj32 = [Mainframe2() for _ in range(27)]
