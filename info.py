...
#===================================== C S E ======================================================================
btechcse11subs=['Maths','Physics','Mechanics','Life skill','Basics of Mechanical & Civil']
btechcse12subs=['Maths','Chemistry','Basics of Electrical & Electronics','Graphics','Professional Communiction','C Programming']
btechcse23subs=['OOPJ','Discrete Mathemetics','Sustainable Engineering','Logic System Design','Data structures','Professional Ethics']
btechcse24subs=['Database Management','COA','Graph Theory','Constitution of India','Operating System','Dedign snd engineering']
btechcse35subs=['Computer Networks','FLAT','Management of Software System','System Software','Disaster Management','MP & MC']
btechcse36subs=['CG & IP','Compiler Design','Algorithm Analysis Design','Python Programming','IEFT','Comprehensive Course Work']
