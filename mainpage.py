...
def mainpageon(username_super):
    ...
    root.title(f'College management system || Logged in as @root-admin_Username={username_super}')
    ...
    # label on header
    intro = Label(frame1, text='S N M I M T', fg='white', font='none 15', bg='black')
...
#-------------------------------------------------------------------------------------
    ...
    design.create_text(630,250,text='S N M I M T ',font='Ebrima 20 bold',fill='#323b38')
    # design.create_text(630,300,text='Powered by Python 3.7',font='Ebrima 30 bold',fill='#323b38')
    design.create_text(630,350,text='Team : 11',font='Ebrima 15 bold',fill='#323b38')
