...
def proceed():
    ...
    def about_section():
        ...
        root_can.create_text(165,300,text='S N M I M T', font=f'{fonttxt} 20 bold',fill=txtclr)
        # root_can.create_text(165,335,text='by', font=f'{fonttxt} 20 ',fill=txtclr)
        #root_can.create_text(165,370,text='Maliankara', font=f'{fonttxt} 20 ',fill=txtclr)
        ...
        root_can.create_text(550,180,text='Abin Krishna V U : Main Designer / Coder', font=f'{fonttxt} 18 bold',fill=txtclr)
        root_can.create_text(565,215,text='Gopika M S ', font=f'{fonttxt} 18 ',fill=txtclr)
        root_can.create_text(535,250,text='Irfana M Iqbal ', font=f'{fonttxt} 18 ',fill=txtclr)
        ...
        root_can.create_text(430,375,text='M. Gireesh Kumar M C', font=f'{fonttxt} 18 ',fill=txtclr)
    ...
    def usersignupfun():
        ...
        #text-----------------------------------------------
        utobj1.text(170,240,'S N M I M T','none 15','white')
        # utobj1.text(270,240,'Gui','none 20 bold','white')
    ...
    #
    intro2=Label(frame1,text='S N M I M T',fg='white',font='none 15',bg='black')
    ...
    canvas1.create_text(380, 350, text='S N M I M T', font=f'{fonttxt} 20 bold', fill='white')
    ...
    def closing_soft():
        ...
        message=globalobj.customlabels(headerframe, 'S N M I M T', 'none 10', 'black', 85, 5,fg='white')
...
def prescreen():
    ...
    root_can.create_text(450,320,text='S N M I M T',font=f'{fonttxt} 25 bold',fill=bgc)
